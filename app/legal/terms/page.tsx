    ...
    <main className="min-h-screen px-4 py-8">
      <div className="max-w-2xl mx-auto space-y-5 text-slate-700">
        ...
        <p className="text-[11px] bg-amber-50 text-amber-700 rounded-lg p-3">
          ⚠️ これは草案テンプレートです。実際にサービスを公開・課金する前に、必ず法務の専門家の確認を受けてください。
          <b>[　]</b> の箇所は運営者情報などを記入してください。
        </p>
        <p className="text-xs text-slate-400">最終更新：2026年7月20日</p>

        <Section n="第1条（適用）">
          本規約は、[運営者名]（以下「運営者」）が提供する家計・損益管理サービス「My PL Ledger」（以下「本サービス」）の
        ...
        <Section n="第7条（料金）">
          本サービスの料金体系は別途定めます（無料範囲・有料プランがある場合はその内容・支払方法を明示します）。
          [課金を導入する場合はここに具体的な条件・解約・返金の方針を記載]
        </Section>
        ...
        <p className="text-xs text-slate-400 pt-2">お問い合わせ：[連絡先メールアドレス]</p>
      </div>
    </main>
  );
}
